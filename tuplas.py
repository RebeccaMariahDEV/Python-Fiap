...
como usar e manipular, por exemplo, tuplas podem ser chaves de um dicionario, pois as chaves não vão mudar; vou explicar
...
"""
Vamos ver o codigo, criamos um dicionario chamado ips. uma variavel chamada resp para controlar nosso laço e, 
dentro do laço de repetição, vamos preencher o nosso dicionario, porem na chave tem dois valores, a primeira parte do 
ip e a segunda dentro de uma tupla, e o dado do elemento que esta sendo adicionado.
...
"""
Unimos as duas partes atraves do indice, ele vai colocar exatamente cada dado nesses posições
...
"""
Veja que pegamos os dados atraves do .items(), já vimos o que ele faz em!, agora vamos ver quais maquinas compõem uma 
...
"""
Até agora já conseguimos notar algumas coisas certo? já vimos como listas, tuplas e dicionarios funcionam, o que devemos
fazer é saber o melhor momento de usar cada tipo de estutura de dados, não devemos escolher um ou outro, temos que saber
tudo por um todo.

Outro exemplo é usarmos a função enumerete(), para listar cada dado dentro de algo, transformando eles em dicionarios ou
em outras coisas 
...
"""
Até o momento a maior preocupação foi te mostrar as estruturas de dados basicas, como manipular e utilizar esses recursos,
com esse basico você desenvolve algo, mas agora vem o divisor de águas, aqui vai ser o momento de se tornar algo a mais,
então estude bastante, treine o que foi feito até agora, se precisar veja a documentação do python.

O proximo passo é banco de dados, aprender a mexer e manipular é mais complicado, porem nada é um bicho de 7 cabeças ok.
